...
export default function Profile(){
    ...
    useEffect(()=>{
        ...
        api.get(uri)
        .then((response)=>{setUserDetails(response.data);console.log(response.data)})
            ...
            <div className="flex gap-3 duration-500 justify-center mx-[15%]">
                ...
                <div className="relative left p-3 flex flex-col justify-center gap-5 items-center self-center w-[30%]  border bg-mine-shaft-900 border-mine-shaft-500 rounded-lg">
                    <div className="  flex gap-2 flex-col justify-center">
                        {isEditing && <input type="file" ><IconUpload className="absolute right-[30%] hover:cursor-pointer hover:scale-110 font-bold"/></input>}
                ...
                <div className="right relative w-[70%] border bg-mine-shaft-900 border-mine-shaft-500 rounded-lg">
                    <div className="absolute  right-[3%] top-[2%] cursor-pointer hover:scale-110" onClick={()=>{setEditing(!isEditing);console.log(isEditing)}}><IconPencil/></div>
                    {/* personal info */}
